...
const TRACKS = {
    'rain': {
        name: 'Rain',
        url: 'https://drive.google.com/uc?export=download&id=1if_itU4zqE799Ve0_tGL87xBq4aAcgyv'
    },
    'wave': {
        name: 'Wave',
        url: 'https://drive.google.com/uc?export=download&id=1JQOHOu9OTgCScny-1tn6sasNf35cnc_J'
    },
    'forest': {
        name: 'Forest',
        url: 'https://drive.google.com/uc?export=download&id=1cajQvhUJJK6ceHNGp7UpVnfLvqlr5A7o'
    },
    'fire': {
        name: 'Fire',
        url: 'https://drive.google.com/uc?export=download&id=1frWC1RS8wceAdUUEw5L1V310znXwRH_e'
    }
};
